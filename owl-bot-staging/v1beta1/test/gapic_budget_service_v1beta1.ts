...
describe('v1beta1.BudgetServiceClient', () => {
    ...
    describe('createBudget', () => {
        it('invokes createBudget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateBudgetRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createBudget as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createBudget as SinonStub)
        ...
        it('invokes createBudget without error using callback', async () => {
            ...
            client.innerApiCalls.createBudget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createBudget(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.billing.budgets.v1beta1.IBudget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createBudget with error', async () => {
            ...
            client.innerApiCalls.createBudget = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateBudget', () => {
        it('invokes updateBudget without error', async () => {
            ...
            request.budget ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateBudgetRequest', ['budget', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateBudget as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateBudget as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateBudget without error using callback', async () => {
            ...
            client.innerApiCalls.updateBudget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateBudget(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.billing.budgets.v1beta1.IBudget|null) => {
        ...
        it('invokes updateBudget with error', async () => {
            ...
            const expectedHeaderRequestParams = `budget.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateBudget = stubSimpleCall(undefined, expectedError);
    ...
    describe('getBudget', () => {
        it('invokes getBudget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetBudgetRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBudget as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBudget as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getBudget without error using callback', async () => {
            ...
            client.innerApiCalls.getBudget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBudget(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.billing.budgets.v1beta1.IBudget|null) => {
    ...
    describe('deleteBudget', () => {
        it('invokes deleteBudget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteBudgetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteBudget as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteBudget as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteBudget without error using callback', async () => {
            ...
            client.innerApiCalls.deleteBudget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteBudget(
                    request,
        ...
        it('invokes deleteBudget with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteBudget = stubSimpleCall(undefined, expectedError);
    ...
    describe('listBudgets', () => {
        it('invokes listBudgets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListBudgetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.Budget()),
              generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.Budget()),
              generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.Budget()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBudgets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBudgets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBudgets without error using callback', async () => {
            ...
            client.innerApiCalls.listBudgets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBudgets(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.billing.budgets.v1beta1.IBudget[]|null) => {
        ...
        it('invokes listBudgets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listBudgets = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listBudgetsStream without error', async () => {
            ...
            client.descriptors.page.listBudgets.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listBudgetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.billing.budgets.v1beta1.Budget[] = [];
                stream.on('data', (response: protos.google.cloud.billing.budgets.v1beta1.Budget) => {
            ...
            assert((client.descriptors.page.listBudgets.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBudgets, request));
            assert(
        ...
        it('invokes listBudgetsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBudgets.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBudgetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.billing.budgets.v1beta1.Budget[] = [];
                stream.on('data', (response: protos.google.cloud.billing.budgets.v1beta1.Budget) => {
        ...
        it('uses async iteration with listBudgets without error', async () => {
            ...
            client.descriptors.page.listBudgets.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listBudgets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBudgets.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBudgetsAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('budget', () => {
            ...
            client.initialize();
            client.pathTemplates.budgetPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.budgetPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('budgetPath', () => {
                const result = client.budgetPath("billingAccountValue", "budgetValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.budgetPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchBillingAccountFromBudgetName', () => {
                ...
                assert.strictEqual(result, "billingAccountValue");
                assert((client.pathTemplates.budgetPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
