...
describe('v1beta1.BudgetServiceClient', () => {
    ...
    describe('createBudget', () => {
        it('invokes createBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.CreateBudgetRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.Budget());
            ...
            assert((client.innerApiCalls.createBudget as SinonStub)
    ...
    describe('updateBudget', () => {
        it('invokes updateBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.UpdateBudgetRequest());
            request.budget = {};
            request.budget.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateBudget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getBudget', () => {
        it('invokes getBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.GetBudgetRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBudget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteBudget', () => {
        it('invokes deleteBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.DeleteBudgetRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteBudget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listBudgets', () => {
        it('invokes listBudgets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.budgets.v1beta1.ListBudgetsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listBudgets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
